...
# Tamper lexical_transforms deterministically
...
if($verifyText -notmatch 'VERIFY_FAIL:LEXICAL_TRANSFORM_HASH_MISMATCH'){
  throw ("NEG_FAIL:WRONG_FAILURE_TOKEN:`n" + $verifyText)
}

Write-Host "COURIER_NEGATIVE_LEXICAL_TRANSFORM_TAMPER_OK"