...
# Tamper recipients deterministically after commit/encrypt
...
if($verifyText -notmatch 'VERIFY_FAIL:RECIPIENT_BINDING_HASH_MISMATCH'){
  throw ("NEG_FAIL:WRONG_FAILURE_TOKEN:`n" + $verifyText)
}

Write-Host "COURIER_NEGATIVE_RECIPIENT_BINDING_MISMATCH_OK"